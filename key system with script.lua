...
local Config = {
    ...
    ServiceId       = 24620, -- Your PlatoBoost Service ID
    PlatoSecret     = "194ffcd5-18fc-4a78-ad08-26861d9c81a1", -- Your PlatoBoost Secret Key
    ...
    -- [3] Scripts & Links
    MainScriptURL   = "https://raw.githubusercontent.com/Keeper13579/Life-Hub/refs/heads/main/final%20v1%20life%20setence%20script%20made%20by%20me.lua", -- The raw URL of your main script
    ...
    -- [6] GUI Management
    OldGuiName      = "Life Hub V1", -- Name of the old GUI to destroy if it's already open
    MainGuiName     = "Life Hub V2", -- Name of the main script's GUI to check if it's already executing

    -- [7] Hub Information & UI Text
    HubName         = "Life Hub V1", -- The main title shown at the top of the GUI
    HubDescription  = "Have Fun" -- The text shown below the title
}
